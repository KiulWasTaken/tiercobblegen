...
public enum ShopGUIItems {
    ...
    farming_beetroot(     "", Material.BEETROOT,      new String[]{""}, 100.0,  0.06,  "farming"),
    farming_carrot(       "", Material.CARROT,        new String[]{""}, 150.0,  0.065,  "farming"),
    farming_potato(       "", Material.POTATO,        new String[]{""}, 300.0,  0.065,  "farming"),
    farming_sugarcane(    "", Material.SUGAR_CANE,    new String[]{""}, 500.0,  0.07,  "farming"),
    farming_melon(        "", Material.MELON,         new String[]{""}, 700.0,  0.08,  "farming"),
    farming_pumpkin(      "", Material.PUMPKIN,       new String[]{""}, 800.0,  0.08,  "farming"),
    farming_netherwart(   "", Material.NETHER_WART,   new String[]{""}, 900.0,  0.15,   "farming"),
    farming_chorusfruit(  "", Material.CHORUS_FRUIT,  new String[]{""}, 0.0,    0.155,   "farming"),
    ...
    farming_kelp(         "", Material.KELP,          new String[]{""}, 400.0,  0.04,  "farming"),
    /** Foraging */
    foraging_oaklog(         "", Material.OAK_LOG,          new String[]{""}, 0.0, 0.08,  "foraging"),
    foraging_birchlog(       "", Material.BIRCH_LOG,        new String[]{""}, 0.0, 0.085,  "foraging"),
    foraging_acacialog(      "", Material.ACACIA_LOG,       new String[]{""}, 0.0, 0.09,  "foraging"),
    foraging_darkoaklog(     "", Material.DARK_OAK_LOG,     new String[]{""}, 0.0, 0.095, "foraging"),
    foraging_sprucelog(      "", Material.SPRUCE_LOG,       new String[]{""}, 0.0, 0.095, "foraging"),
    foraging_junglelog(      "", Material.JUNGLE_LOG,       new String[]{""}, 0.0, 0.1, "foraging"),
    foraging_crimsonlog(     "", Material.CRIMSON_STEM,     new String[]{""}, 0.0, 0.12,  "foraging"),
    foraging_warpedlog(      "", Material.WARPED_STEM,      new String[]{""}, 0.0, 0.12,  "foraging"),
    foraging_cherrylog(      "", Material.CHERRY_LOG,       new String[]{""}, 0.0, 0.085,  "foraging"),
    ...
    /** Fishing */
    fishing_cod(           "", Material.COD,            new String[]{""}, 0.0, 0.08,  "fishing"),
    fishing_salmon(        "", Material.SALMON,         new String[]{""}, 0.0, 0.09,  "fishing"),
    ...
    /** Redstone */
    redstone_redstone(         "", Material.REDSTONE,          new String[]{""}, 4.0, 0.0, "redstone"),
